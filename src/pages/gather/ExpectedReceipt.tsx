      ...
      {inputTokensLength === 0 ? (
        ...
        <div className="flex flex-1 gap-8 items-center border-t">
          <div className="flex items-center">
            <button onClick={onClickGather} className="btn-primary-o flex items-center justify-center bg-white shadow-lg py-4 px-12 border rounded-xl">
              <TokenIcon token={selectedToken} size="lg" />
              <p className="ml-1.5 text-2xl font-bold -mt-0.5">
                Gather {inputTokensLength} Assets into {selectedToken.symbol}
              </p>
            </button>
          </div>
